# Contributing to Rainsure

Thank you for contributing to Rainsure! This guide will help you get started.
...
```bash
git clone https://github.com/grantfox-org/rainsure.git
cd rainsure
pnpm install
pnpm dev
```
...
fix: resolve storage collision in rainsure
...
Open a [Discussion](https://github.com/grantfox-org/rainsure/discussions) on GitHub.
