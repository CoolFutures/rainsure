...
const ROUTES = ['policies', 'pools', 'triggers', 'partners', 'roadmap', 'claims'];
  ...
  return (
    <nav className="fixed top-0 w-full z-50 border-b border-white/10 bg-black/40 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/" className="font-bold text-xl tracking-tight">Rainsure</Link>
        ...
        <a href="https://github.com/grantfox-org/rainsure" target="_blank" rel="noopener noreferrer"
