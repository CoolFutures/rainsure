//! Fuzz test suite for RainSure claim logic — #978
//! Author: Freya Hansen (2026-05-11)
//!
...
#[test]
fn fuzz_boundary_trigger_threshold_978() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn fuzz_coverage_overflow_protection_978() {
...
#[test]
fn fuzz_oracle_consensus_divergence_978() {
...
#[test]
fn fuzz_expired_policy_rejection_978() {
