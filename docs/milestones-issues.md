# GitHub Issues Backlog — Rainsure

## Batch 1 — Foundation & Scaffolding (Phase 1)

### Issue 1: Initialize `policy-factory` contract scaffold
...
### Issue 2: Define storage data types for `policy-factory`
**Labels:** `contracts` `good first issue` `phase-1`
...
### Issue 3: Implement `policy-factory` core write functions
...
### Issue 4: Implement `policy-factory` query functions
**Labels:** `contracts` `good first issue` `phase-1`
...
### Issue 5: Initialize `risk-pool` contract scaffold
**Labels:** `contracts` `good first issue` `phase-1`
Mirror of Issue 1 for the `risk-pool` contract.
**Acceptance Criteria:** Compiles, `initialize` called once, version exposed.

---

### Issue 6: Implement `risk-pool` pool/management logic
**Labels:** `contracts` `phase-1`
Implement the core pooling or management logic unique to `risk-pool`.
**Acceptance Criteria:** Integration test simulates full lifecycle, edge cases covered.

---

### Issue 7: Initialize `payout-engine` contract scaffold
**Labels:** `contracts` `good first issue` `phase-1`
Scaffold the `payout-engine` contract with required entrypoints.
**Acceptance Criteria:** Compiles, unit tested.

---

### Issue 8: Implement `payout-engine` execution logic
**Labels:** `contracts` `phase-1`
